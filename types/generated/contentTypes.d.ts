...
export interface ApiOrganicOrganic extends Schema.CollectionType {
  collectionName: 'organics';
  info: {
    singularName: 'organic';
    pluralName: 'organics';
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    recomended: Attribute.Boolean & Attribute.DefaultTo<false>;
    quantity: Attribute.Float;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::organic.organic': ApiOrganicOrganic;
